...
if __name__ == "__main__":
    ...
    parser.add_argument("-a","--action", choices=["c","d"], help="Accion que ejecutara: c omprimir, d escomprimir", required=True)
    parser.add_argument("-f","--file", help="Archivo del cual sacar la informacion para comprimir/descomprimir")
    args = parser.parse_args()
    main(filename = args.file, action = args.action)
